...
import com.csys.compte.service.ModuleService;
...
public class ModuleResource {
  ...
  public ResponseEntity<ModuleDTO> updateModule(@Valid @RequestBody ModuleDTO moduleDTO) throws MethodArgumentNotValidException {
    log.debug("Request to update Module: {}");
